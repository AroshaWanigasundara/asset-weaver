...
interface QueryDef {
  ...
  label: string;
  storage: string;
  args: { name: string; type: "u64" | "u32" | "AccountId" }[];
}
...
const QUERIES: QueryDef[] = [
  ...
  { key: "assets", label: "Assets(asset_id)", storage: "assets", args: [{ name: "asset_id", type: "u64" }] },
  { key: "assetOwner", label: "AssetOwner(asset_id)", storage: "assetOwner", args: [{ name: "asset_id", type: "u64" }] },
  { key: "frozenAssets", label: "FrozenAssets(asset_id)", storage: "frozenAssets", args: [{ name: "asset_id", type: "u64" }] },
  { key: "contractSignatures", label: "ContractSignatures(asset_id, account)", storage: "contractSignatures",
    args: [{ name: "asset_id", type: "u64" }, { name: "account", type: "AccountId" }] },
  { key: "contractHistory", label: "ContractHistory(asset_id, version)", storage: "contractHistory",
    args: [{ name: "asset_id", type: "u64" }, { name: "version", type: "u32" }] },
  { key: "contractHistoryCount", label: "ContractHistoryCount(asset_id)", storage: "contractHistoryCount",
    args: [{ name: "asset_id", type: "u64" }] },
  { key: "collections", label: "Collections(collection_id)", storage: "collections",
    args: [{ name: "collection_id", type: "u64" }] },
  { key: "collectionRoles", label: "CollectionRoles(collection_id, account)", storage: "collectionRoles",
    args: [{ name: "collection_id", type: "u64" }, { name: "account", type: "AccountId" }] },
